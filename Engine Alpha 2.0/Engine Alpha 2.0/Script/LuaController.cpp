...
LuaController* LuaController::getInstance()
{
	if (_pInstance == nullptr)
	{
		...
		{
			_pInstance->registerScriptFunction();
		}
		else
		{
...
void LuaController::setOpenGLRenderer(OpenGLRenderer* opengl_renderer)
{
	_pOpeglrenderer = opengl_renderer;
}

OpenGLRenderer* LuaController::getOpenGLRenderer()
{
	return _pOpeglrenderer;
}
